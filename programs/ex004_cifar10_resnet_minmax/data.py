...
NFG SVRG原論文7節の実験（ResNet-18によるCIFAR-10分類）に対応するデータセットを構築する．
CIFAR-10は32×32ピクセルのカラー画像からなる10クラスの画像分類データセットであり，訓練データ数
...
RAW_DATA_DIR = os.path.join(_PROJECT_ROOT, "datasets", "ex004_cifar10_resnet_minmax", "raw")
